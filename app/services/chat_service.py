...
The user data is as follows:{googleStudentData(STUDENT_ID)}, The user memories across the past interactions are as follows: {retrieve_profile_memories()}"""
